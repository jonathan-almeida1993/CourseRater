...
public class SubmitAReviewPage {
	...
	public static final String instructorDropdown = "//select[@id='instructorDropdownRV']";
	
	public static final String ratingLabel = "//label[.='*Rating:']";
	public static final String stars = "(//img[@class='rating-star-check' and contains(@id, 'ratingStarChk')]/..)";
	...
	public static final String newReviewSection = "//div[@id='newReviewText']";
