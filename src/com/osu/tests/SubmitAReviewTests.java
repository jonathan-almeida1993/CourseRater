...
public class SubmitAReviewTests extends SeleniumUtils{
	...
	public void submitReviewTest2() {
		...
		/*Assert.assertTrue(isElementAvailable(Locator.XPATH, SubmitAReviewPage.reviewSubmitConfirmationTxt, "Submit Review Confirmation text"));
		click(Locator.XPATH, SubmitAReviewPage.reviewSubmitConfirmartionOkBtn, "'Ok' submit review confirmation button");*/
	}
